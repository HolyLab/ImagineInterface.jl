...
findoutputs(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isoutput(x), coms)
getoutputs(coms::AbstractVector{T}) where{T<:ImagineSignal} = view(coms, findoutputs(coms))
findinputs(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isinput(x), coms)
...
findfree(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isfree(x), coms)
...
findpositioners(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->ispos(x), coms)
...
findpositionermonitors(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isposmonitor(x), coms)
...
findcameras(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->iscam(x), coms)
...
findcameramonitors(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->iscammonitor(x), coms)
...
findlasers(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->islas(x), coms)
...
findstimuli(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isstim(x), coms)
...
findgalvos(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->iscam(x), coms)
...
findgalvomonitors(coms::AbstractVector{T}) where{T<:ImagineSignal} = findall(x->isgalvomonitor(x), coms)
