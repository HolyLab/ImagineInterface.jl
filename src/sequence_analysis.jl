...
find_pulse_starts(pulses::AbstractVector{T}, thresh::T) where T = find_pulse_starts(pulses.>=thresh)
find_pulse_stops(pulses::AbstractVector{T}, thresh::T) where T = find_pulse_stops(pulses.>=thresh)
...
count_pulses(pulses::AbstractVector{T}, thresh::T) where T = length(find_pulse_starts(pulses, thresh))
